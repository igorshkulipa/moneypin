...
define(['helpers/guid'], function (guid) {
    return function (id, date, amount, category, account, description, operation, accounts) {
        ...
        Object.defineProperty(object, 'localeDate', {
            ...
            get: function get() {
                ...
                if (d.getDay() == now.getDay() && d.getMonth() == now.getMonth() && d.getYear() == now.getYear()) {
                    return 'Today' + ',  ' + d.toLocaleTimeString();
                }

                if (d.getDay() == yesterday.getDay() && d.getMonth() == yesterday.getMonth() && d.getYear() == yesterday.getYear()) {
